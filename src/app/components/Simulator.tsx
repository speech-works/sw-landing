            ...
            <div className="hidden w-full justify-center z-30 md:flex">
              <div className="w-full max-w-full md:w-auto bg-white/70 backdrop-blur-3xl border border-white/60 p-1.5 rounded-full shadow-lg flex items-center gap-1 overflow-x-auto hide-scrollbar">
                <button
                  ...
                  className={`magnetic-btn pointer-none-children group flex items-center gap-2 px-4 py-2 rounded-full transition-all duration-500 whitespace-nowrap outline-none cursor-pointer sm:gap-3 sm:px-5 sm:py-2.5 ${activeSimulator === 1
                ...
                <button
                  ...
                  className={`magnetic-btn pointer-none-children group flex items-center gap-2 px-4 py-2 rounded-full transition-all duration-500 whitespace-nowrap outline-none cursor-pointer sm:gap-3 sm:px-5 sm:py-2.5 ${activeSimulator === 2
                      ? "bg-app-text text-white shadow-[0_10px_30px_-10px_rgba(0,0,0,0.5)]"
                      : "bg-transparent text-app-muted hover:bg-black/5"
                    }`}
                >
                ...
                <button
                  ...
                  className={`magnetic-btn pointer-none-children group flex items-center gap-2 px-4 py-2 rounded-full transition-all duration-500 whitespace-nowrap outline-none cursor-pointer sm:gap-3 sm:px-5 sm:py-2.5 ${activeSimulator === 3
                      ? "bg-app-text text-white shadow-[0_10px_30px_-10px_rgba(0,0,0,0.5)]"
                      : "bg-transparent text-app-muted hover:bg-black/5"
                    }`}
                >
