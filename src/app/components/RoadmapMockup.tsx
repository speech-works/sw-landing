...
import BreathingAppMockup from "./BreathingAppMockup";
      ...
      */}
      <div className="relative w-[325px] h-[660px] shadow-2xl transition-transform duration-700 hover:scale-[1.02] group/phone rounded-[3.5rem] ring-1 ring-white/10 origin-center">
        ...
        */}
          ...
          <div className="absolute inset-0 bg-white rounded-[inherit] overflow-hidden isolate">
            {isBlank ? (
              ...
              <div className="absolute inset-0 flex flex-col pt-16 px-4 bg-[#f9fafb]">
                ...
                <div
                  className={`w-full h-32 rounded-2xl bg-gradient-to-br ${theme.from} ${theme.to} opacity-40 mb-4`}
                />
            ...
            {comingSoon && (
              <div className="absolute inset-0 z-50 flex flex-col items-center justify-start pt-20 bg-[#050505] rounded-[inherit] overflow-hidden group/lock p-8">
                ...
                <div
                  className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 rounded-full blur-[80px] opacity-20"
                ...
                <div className="relative mb-10 animate-platform-float">
                  ...
                  >
                    <path
                      d="M17 11V7C17 4.23858 14.7614 2 12 2C9.23858 2 7 4.23858 7 11"
                      stroke="white"
                      strokeWidth="1.5"
                      strokeLinecap="round"
            ...
            <div className="absolute bottom-2 md:bottom-3 inset-x-0 flex justify-center z-[80]">
              <div
                className={`w-24 md:w-32 h-1.5 rounded-full ${
                  comingSoon ? "bg-white/30" : "bg-black/10"
                }`}
              />
            </div>
        ...
        <div className="absolute top-[85px] -left-[4px] w-[7px] h-9 bg-gradient-to-r from-[#0a0a0a] via-[#3a3a3a] to-[#2a2a2a] z-20 rounded-l-[3px] border-y border-l border-white/10 shadow-[1px_0_3px_rgba(0,0,0,0.5)]" />{" "}
        {/* Action Button */}
        <div className="absolute top-[140px] -left-[4px] w-[7px] h-14 bg-gradient-to-r from-[#0a0a0a] via-[#3a3a3a] to-[#2a2a2a] z-20 rounded-l-[3px] border-y border-l border-white/10 shadow-[1px_0_3px_rgba(0,0,0,0.5)]" />{" "}
        {/* Volume Up */}
        <div className="absolute top-[210px] -left-[4px] w-[7px] h-14 bg-gradient-to-r from-[#0a0a0a] via-[#3a3a3a] to-[#2a2a2a] z-20 rounded-l-[3px] border-y border-l border-white/10 shadow-[1px_0_3px_rgba(0,0,0,0.5)]" />{" "}
        {/* Volume Down */}
