...
function DailyProgressFloatingCard() {
    const freeActivityPercent = (FREE_ACTIVITY_CURRENT / FREE_ACTIVITY_TOTAL) * 100;
            ...
            <div className="relative z-10">
                ...
                <div className="mt-3 rounded-[18px] bg-white/95 px-[10px] pb-[10px] pt-[10px] shadow-[0_12px_24px_rgba(138,63,14,0.14)]">
                    ...
                    <div className="mt-2 flex justify-end">
                        <span className="text-[7px] font-semibold text-slate-400">~18h 29m until full</span>
                    </div>
                    ...
                    <div className="mt-2.5 grid grid-cols-2 gap-2">
                        <div className="relative overflow-hidden rounded-[14px] bg-[#F1F5F9] p-2">
                            ...
                            <div className="mt-3 h-[4px] w-full overflow-hidden rounded-full bg-[rgba(16,185,129,0.1)]">
                                <div className="h-full rounded-full bg-[#10B981]" style={{ width: `${freeActivityPercent}%` }} />
                            </div>
                        </div>
                        ...
                        <div className="relative overflow-hidden rounded-[14px] bg-[#F1F5F9] p-2">
                            ...
                            <div className="mt-1.5 h-[4px] w-full overflow-hidden rounded-full bg-[rgba(249,115,22,0.1)]">
                                <div className="h-full rounded-full bg-[#F97316]" style={{ width: `${xpPercent}%` }} />
                            </div>
                        </div>
                    </div>
                </div>
    ...
    return (
        ...
        >
            ...
            <p className="mx-auto mb-4 max-w-[172px] text-[9px] leading-[1.45] text-slate-500">
                Your stamina is running low because you&apos;ve practiced hard today. Take a break and come back stronger.
            </p>
...
function PhoneShell({ mousePos }: { mousePos: { x: number; y: number } }) {
    return (
        <div className="relative h-[492px] w-[276px]" style={{ transformStyle: "preserve-3d" }}>
            <div
...
export default function StaminaAppMockup({ 
    ...
    const compositionTransform = `translateY(${isHovered ? "-6px" : "0px"}) scale(${isHovered ? 1.005 : 0.99})`;
    ...
    return (
        ...
        >
            ...
            <div
                ...
                style={{ transformStyle: "preserve-3d", transform: compositionTransform }}
            >
                ...
                <div
                    ...
                    style={{
                        transform: `translate3d(calc(-50% + ${isHovered ? "-1px" : "0px"}), ${isHovered ? "-12px" : "-4px"}, 0) rotate(-2deg)`,
                ...
                >
                    <div
                        ...
                        style={{
                            transformStyle: "preserve-3d",
                            animation: "stamina-carousel-plane 8.6s ease-in-out infinite",
                            ["--stamina-slide-shift" as const]: "224px",
                        }}
                    >
                        <div
                            className="flex items-start gap-4 px-1 will-change-transform"
                            style={{
                                animation: "stamina-carousel-track 8.6s cubic-bezier(0.65, 0, 0.35, 1) infinite",
                            }}
                        >
                            <div className="rounded-[24px]" style={{ animation: "stamina-carousel-card 8.6s ease-in-out infinite" }}>
