  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="absolute inset-0 rounded-[3.5rem] bg-black shadow-[30px_60px_60px_rgba(0,0,0,0.4)] border-[6px] border-slate-800"
        ...
        <div
          ...
          style={{
            transform: isHovered
              ? "translateZ(100px) translateX(15px) rotateY(-5deg)"
              : "translateZ(50px)",
            zIndex: 100,
          }}
        >
          {radarChart ? (
            ...
            <div className="w-full h-full bg-white/40 backdrop-blur-lg rounded-2xl border border-white/30 shadow-2xl p-4">
              <div className="w-full h-full rounded-xl border-2 border-dashed border-white/50 flex items-center justify-center opacity-40">
                <div className="text-[10px] font-bold text-slate-800/40 uppercase tracking-widest">
                  Growth Metric
                </div>
              </div>
            </div>
        ...
        <div
          ...
          style={{
            transform: isHovered
              ? "translateZ(200px) rotateY(-20deg)"
              : "translateZ(150px)",
          }}
        >
