...
export default function LiveAppMockup() {
  ...
  return (
    <div className="w-full h-full bg-[#f9fafb] text-slate-800 flex flex-col font-sans overflow-hidden rounded-[inherit] relative select-none">
      {/* Top Status Bar Mock */}
      <div className="w-full pt-3 pb-2 px-5 flex justify-between items-center text-[10px] font-medium text-slate-900 bg-[#f9fafb] z-30 shrink-0 shadow-sm border-b border-transparent backdrop-blur-md absolute top-0 left-0 right-0">
      ...
      <div className="flex-1 overflow-hidden relative pt-10 mask-fade-edges rounded-b-[inherit]">
        ...
        >
          ...
          {/* 1. Clinical Assessment (OASES Replica) */}
          <div className="w-full rounded-[20px] overflow-hidden bg-gradient-to-br from-[#F97316] to-[#EA580C] p-4 pb-4 text-white relative shadow-[0_4px_12px_rgba(234,88,12,0.15)] min-h-[160px] flex flex-col justify-between shrink-0">
            ...
            <div className="relative z-10">
              ...
              <p className="text-[10px] text-white/90 max-w-[65%] leading-snug">
                14 questions remaining • Answer at your own pace.
              </p>
            </div>
          ...
          {/* Tracking / Growth Profile Bottom Card Peek */}
          <div className="w-full rounded-t-[20px] overflow-hidden bg-white p-3 pb-8 relative shadow-[0_0_10px_rgba(0,0,0,0.02)] transition-all duration-1000 delay-400 ease-out border-x border-t border-slate-100 shrink-0 mb-6">
            <div className="inline-flex items-center gap-1 mb-1">
              <RefreshCw className="w-2.5 h-2.5 text-[#EA580C]" />
              <span className="text-[8px] font-bold text-[#EA580C] uppercase tracking-wider">
                Tracking
              </span>
            </div>
            <h3 className="text-[16px] font-bold text-[#3E2723] leading-tight">
              Growth Profile
            </h3>
      ...
      <div
        className="absolute bottom-[16px] left-3 right-3 flex justify-between items-center bg-white rounded-[24px] h-[52px] px-2 shadow-[0_8px_20px_rgba(100,116,139,0.15)] z-30 transition-all duration-1000 delay-[200ms] ease-out border border-slate-100"
        style={{
          opacity: mounted ? 1 : 0,
      ...
      <style>{`
        ...
        /* Smooth looping auto-scroll mimicking a user exploring the app */
        .animate-app-pan {
           animation: pan-scroll 16s ease-in-out infinite;
        }

        @keyframes pan-scroll {
           0%, 30% { transform: translateY(0); } /* Look at top card */
           45%, 80% { transform: translateY(-190px); } /* Scroll down to see daily progress */
           95%, 100% { transform: translateY(0); } /* Smoothly ping-pong back to top */
        }
