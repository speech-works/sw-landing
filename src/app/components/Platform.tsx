  ...
  return (
    <div
      ...
      style={{
        ...
        animation:
          "platform-staminaSlide 0.75s cubic-bezier(0.23,1,0.32,1) 0.3s both",
      }}
    >
      <div className="relative w-14 h-14 md:w-16 md:h-16 flex items-center justify-center shrink-0">
        ...
        >
          ...
          <circle
            ...
            style={{
              animation:
                "platform-circleStroke 1.8s cubic-bezier(0.23,1,0.32,1) 0.6s both",
            }}
          />
        </svg>
  ...
  return (
    <div
      ...
      style={{
        ...
        animation:
          "platform-springUp 0.75s cubic-bezier(0.23,1,0.32,1) 0.2s both",
      }}
    >
      ...
      <div className="flex items-center gap-4 relative z-10">
        <div
          ...
          style={{
            animation:
              "platform-popIn 0.55s cubic-bezier(0.23,1,0.32,1) 0.45s both",
          }}
        >
      ...
      <div className="w-full h-2 bg-slate-100 rounded-full mt-2 relative overflow-hidden z-10">
        <div
          ...
          style={{
            animation:
              "platform-barFill 1.4s cubic-bezier(0.23,1,0.32,1) 0.65s both",
          }}
        />
      </div>
    </div>
