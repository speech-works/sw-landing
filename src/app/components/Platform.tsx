...
function RadarUI({ animKey }: { animKey: number }) {
  return (
    <div
      key={animKey}
      className="absolute -right-2 md:-right-4 -bottom-4 w-[140px] md:w-[170px] p-4 rounded-2xl border border-white/20 antialiased overflow-visible"
      style={{
        background: "rgba(255,255,255,0.45)",
        backdropFilter: "blur(12px)",
        boxShadow: "0 15px 30px rgba(0,0,0,0.07)",
        animation: "platform-springUp 0.7s cubic-bezier(0.23,1,0.32,1) 0.25s both",
      }}
    >
...
const features = [
  {
    ...
    activeBar: "bg-brand",
    renderUI: (animKey: number) => <RadarUI animKey={animKey} />,
  },
  {
    id: "adversarial",
