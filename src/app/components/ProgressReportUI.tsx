...
const DetailedWeeklySummary = () => (
    <div className="relative rounded-[20px] overflow-hidden bg-gradient-to-br from-[#8B5CF6] to-[#6D28D9] shadow-lg shadow-purple-500/30 p-[18px]">
        <div className="absolute top-[-50px] right-[-50px] w-[180px] h-[180px] rounded-full bg-white/[0.08]" />
        <div className="absolute bottom-[-40px] left-[-40px] w-[140px] h-[140px] rounded-full bg-white/[0.08]" />

        <div className="relative z-10 flex flex-col gap-[20px]">
            <div className="flex justify-between items-start">
                <div className="flex-1">
                    <h4 className="text-[10px] font-bold text-white/90 tracking-[1.px] uppercase mb-[4px]">PATHFINDER V</h4>
            ...
            <div className="flex gap-[10px]">
                <div className="flex-1 bg-white/12 rounded-[14px] p-[10px] px-[14px] flex items-center gap-[8px] border border-white/5">
                    <ClockIcon />
...
const DPSummary = () => (
    <div className="relative rounded-[20px] overflow-hidden bg-gradient-to-br from-[#60A5FA] to-[#3B82F6] shadow-lg shadow-blue-500/20 p-[18px]">
        <div className="absolute top-[-50px] right-[-50px] w-[180px] h-[180px] rounded-full bg-white/6" />
        <div className="absolute bottom-[-40px] left-[-40px] w-[140px] h-[140px] rounded-full bg-white/6" />

        <div className="relative z-10 flex flex-col gap-[16px]">
            <div className="flex justify-between items-center">
                <div>
                    <h4 className="text-[10px] font-bold text-white/90 tracking-[1.px] uppercase mb-0.5">PRACTICE DISTRIBUTION</h4>
            ...
            <div className="flex flex-wrap gap-[6px] justify-center">
                {["Cognitive", "Fun", "Exposure", "Reading"].map((label, i) => {
                    ...
                    return (
                        <div key={label} className="bg-white/10 border border-white/5 px-[10px] py-[4px] rounded-[18px] flex items-center gap-[5px]">
            ...
            <div className="relative flex items-center justify-center py-2 h-[160px]">
                <svg viewBox="0 0 100 100" className="w-[150px] h-[150px] -rotate-90">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                    <div className="bg-white w-[90px] h-[90px] rounded-full shadow-lg flex flex-col items-center justify-center border-[3px] border-black/[0.02]">
                ...
                <div className="absolute top-[20%] right-[15%] bg-white px-[7px] py-[3px] rounded-[10px] shadow-sm text-[9px] font-black text-[#1E293B] border border-black/5">34%</div>
                <div className="absolute bottom-[22%] right-[22%] bg-white px-[7px] py-[3px] rounded-[10px] shadow-sm text-[9px] font-black text-[#1E293B] border border-black/5">28%</div>
                <div className="absolute bottom-[22%] left-[12%] bg-white px-[7px] py-[3px] rounded-[10px] shadow-sm text-[9px] font-black text-[#1E293B] border border-black/5">19%</div>
                <div className="absolute top-[25%] left-[18%] bg-white px-[7px] py-[3px] rounded-[10px] shadow-sm text-[9px] font-black text-[#1E293B] border border-black/5">19%</div>
            </div>

            <div className="grid grid-cols-2 gap-[10px]">
                <div className="relative bg-white/10 rounded-[16px] p-[14px] border border-white/12 flex flex-col gap-[10px] overflow-hidden">
                    <div className="absolute -bottom-2 -right-1 opacity-10">
                        <svg width="40" height="40" fill="white" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"/><circle cx="12" cy="12" r="3"/></svg>
                    </div>
                    ...
                    <div className="h-[4px] bg-white/15 rounded-full overflow-hidden z-10">
                ...
                <div className="relative bg-white/10 rounded-[16px] p-[14px] border border-white/12 flex flex-col gap-[10px] overflow-hidden">
                    ...
                    <div className="h-[4px] bg-white/15 rounded-full overflow-hidden z-10">
                        <div className="h-full bg-[#60A5FA] w-[45%]" />
                    </div>
                </div>
            </div>
        </div>
...
const Achievements = () => (
    <div className="relative rounded-[20px] overflow-hidden bg-gradient-to-br from-[#10B981] to-[#059669] shadow-lg shadow-emerald-500/20 p-[18px]">
        <div className="absolute top-[-50px] right-[-50px] w-[180px] h-[180px] rounded-full bg-white/10" />
        <div className="absolute bottom-[-40px] left-[-40px] w-[140px] h-[140px] rounded-full bg-white/10" />
        <div className="relative z-10 flex flex-col gap-[16px]">
            <div className="flex justify-between items-center">
                <h4 className="text-[10px] font-bold text-white/90 tracking-[1.px] uppercase">ACHIEVEMENTS</h4>
                <div className="w-[30px] h-[30px] rounded-[9px] bg-white/15 flex items-center justify-center border border-white/5">
                    <span className="text-white text-base">⭐</span>
                </div>
            </div>
            <div className="bg-white/20 border border-white/30 px-[14px] py-[8px] rounded-[14px] self-start shadow-sm">
                <span className="text-[16px] font-black text-white">450 XP</span>
            </div>
            <div className="flex flex-col gap-[6px]">
                <div className="h-[10px] bg-white/20 rounded-[5px] border border-white/20 overflow-hidden">
                    <div className="h-full bg-white w-[65%]" />
                </div>
                <span className="text-[11px] font-bold text-white/85">Only 150 XP more for Level 6</span>
            </div>
            <div className="relative bg-white/12 border border-white/20 rounded-[16px] p-[16px] flex flex-col gap-[10px] overflow-visible mt-2">
                <div className="absolute top-[-8px] right-[-4px] bg-[#F43F5E] px-[8px] py-[3px] rounded-[10px] shadow-sm z-20">
                    <span className="text-[9px] font-black text-white uppercase tracking-[0.5px]">You're here</span>
                </div>
                <div className="flex items-center gap-[12px]">
                    <div className="w-[44px] h-[44px] rounded-full bg-white/20 border border-white/30 flex items-center justify-center shadow-inner">
...
export default function ProgressReportUI() {
    return (
        <div className="flex-1 w-full bg-[#FCF9F7] flex flex-col overflow-hidden relative">
            ...
            {/* Translucent Header / Status Bar Combo - Scrolling content passes UNDER this */}
            <div className="absolute top-0 left-0 right-0 h-[72px] z-[120] bg-[#FCF9F7]/85 backdrop-blur-xl border-b border-black/5 flex items-end pb-[6px] px-6">
            ...
            <div className="flex-1 overflow-y-auto px-[6px] scrollbar-hide scale-[0.92] origin-top">
                {/* Scroll Margin (Sticks cards close to translucent header) */}
