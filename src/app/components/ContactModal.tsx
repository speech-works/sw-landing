      ...
      >
        ...
        <div className="relative z-10 flex w-full flex-col">
          <div className="mb-7 max-w-[400px] md:mb-10">
            {/* The Badge */}
            <div className={`mb-5 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-3 py-1.5 shadow-sm transition-all duration-700 ease-[cubic-bezier(0.34,1.56,0.64,1)] md:mb-6 ${isRendered ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
            ...
            <h2 className={`mb-3 text-[36px] font-semibold tracking-tight text-white transition-all duration-700 delay-75 ease-[cubic-bezier(0.34,1.56,0.64,1)] sm:text-[40px] md:mb-4 md:text-[44px] ${isRendered ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
              Let&apos;s talk.
            </h2>
            <p className={`text-[15px] font-normal leading-[1.65] text-[#A39B95] transition-all duration-700 delay-150 ease-[cubic-bezier(0.34,1.56,0.64,1)] md:text-[16px] ${isRendered ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
            ...
            >
               <div className="flex items-center gap-4 md:gap-5">
                 <div className="relative">
                   ...
                   <div className="relative flex h-11 w-11 items-center justify-center rounded-full border border-white/5 bg-[#141210] shadow-lg transition-all duration-500 group-hover:scale-110 group-hover:border-[#10b981]/30 md:h-12 md:w-12">
                 ...
                 <div>
                   <div className="mb-0.5 text-[15px] font-medium text-white transition-colors duration-300 group-hover:text-[#10b981] md:text-[16px]">Message on WhatsApp</div>
                   <div className="text-[12px] font-medium tracking-wide text-[#A39B95] opacity-80 transition-opacity duration-300 group-hover:opacity-100 md:text-[13px]">
                     We usually reply in minutes
                   </div>
                 </div>
               </div>

               <div className="flex h-8 w-8 shrink-0 items-center justify-center transition-all duration-500 ease-[cubic-bezier(0.34,1.56,0.64,1)] transform group-hover:translate-x-2">
                 <svg className="h-4 w-4 text-white/30 transition-colors duration-300 group-hover:text-[#10b981]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="5" x2="19" y1="12" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
               </div>
            </a>
            ...
            >
               <div className="flex items-center gap-4 md:gap-5">
                 <div className="relative">
                   ...
                   <div className="relative flex h-11 w-11 items-center justify-center rounded-full border border-white/5 bg-[#141210] shadow-lg transition-all duration-500 group-hover:scale-110 group-hover:border-brand/30 md:h-12 md:w-12">
                     <svg className="h-5 w-5 text-brand opacity-70 transition-opacity duration-300 group-hover:opacity-100" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>
                   </div>
                 </div>
                 
                 <div>
                   <div className="mb-0.5 text-[15px] font-medium text-white transition-colors duration-300 group-hover:text-brand md:text-[16px]">Send an Email</div>
                   <div className="text-[12px] font-medium tracking-wide text-[#A39B95] opacity-80 transition-opacity duration-300 group-hover:opacity-100 md:text-[13px]">
               ...
               <div className="flex h-8 w-8 shrink-0 items-center justify-center transition-all duration-500 ease-[cubic-bezier(0.34,1.56,0.64,1)] transform group-hover:translate-x-2">
                 <svg className="h-4 w-4 text-white/30 transition-colors duration-300 group-hover:text-brand" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="5" x2="19" y1="12" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
               </div>
            </a>
          </div>
