                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 md:gap-12 mb-16 md:mb-20">
                      <div className="sm:col-span-2">
                          <div className="flex items-center gap-3 mb-4 md:mb-6">
                              <div className="w-8 h-8 rounded-full bg-white flex items-center justify-center text-brand font-bold text-sm shadow-sm">S</div>
                              <span className="font-bold text-lg md:text-xl tracking-tight text-white">Speechworks</span>
                          </div>
                          <p className="text-brand-50 font-medium max-w-sm text-sm md:text-base leading-relaxed">Combining AI-powered practice, a supportive community, and professional therapists to help you speak on your terms.</p>
                      </div>
                      
                      <div>
                          <h4 className="text-white font-bold mb-4 md:mb-6 tracking-widest text-[10px] md:text-xs uppercase">Platform</h4>
                      ...
                      <div>
                          <h4 className="text-white font-bold mb-4 md:mb-6 tracking-widest text-[10px] md:text-xs uppercase">Company</h4>
                          <ul className="space-y-3 md:space-y-4 text-sm font-medium text-brand-100">
              ...
              <div className="w-full border-t border-white/20 pt-10 md:pt-16 pb-6 md:pb-8 overflow-hidden flex relative z-10">
                  <div className="marquee-container w-full">
                      <div className="marquee-content slow flex flex-nowrap items-center text-[18vw] font-black tracking-tighter leading-none select-none py-2 md:py-4">
                          <span className="text-white px-4 md:px-8 drop-shadow-sm">SPEECHWORKS</span>
                          <span className="text-white/30 px-4 md:px-8">•</span>
                          <span className="text-white px-4 md:px-8 drop-shadow-sm">SPEECHWORKS</span>
                          <span className="text-white/30 px-4 md:px-8">•</span>
                      </div>
                      <div className="marquee-content slow flex flex-nowrap items-center text-[18vw] font-black tracking-tighter leading-none select-none py-2 md:py-4" aria-hidden="true">
                          <span className="text-white px-4 md:px-8 drop-shadow-sm">SPEECHWORKS</span>
                          <span className="text-white/30 px-4 md:px-8">•</span>
                          <span className="text-white px-4 md:px-8 drop-shadow-sm">SPEECHWORKS</span>
                          <span className="text-white/30 px-4 md:px-8">•</span>
