...
export default function RoadmapAppMockup({
    ...
    return (
        ...
        >
            <div
                key={animKey}
                className="relative h-[500px] w-[240px] transition-transform duration-1000 ease-[cubic-bezier(0.23,1,0.32,1)] md:h-[540px] md:w-[260px]"
                style={{
                    transformStyle: "preserve-3d",
                    transform: `rotateX(${rotateX}deg) rotateY(${rotateY}deg) rotateZ(${rotateZ}deg) scale(${isSectionHovered ? hoverScale : idleScale})`,
                }}
            >
                <div
